...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Silver Operations — Ops Panel" },
      {
        name: "description",
        content:
          "Silver Operations: modular panel for call operations, leads CRM, mail deliverability, hosting and administration.",
      },
      { property: "og:title", content: "Silver Operations — Ops Panel" },
      {
        property: "og:description",
        content:
          "Modular operations panel: SilverCall Center, SilverLeads CRM, SilverMailer, SilverHost and administration.",
      },
          ...
          <div className="flex min-w-0 flex-1 flex-col">
            <header className="sticky top-0 z-10 flex h-14 items-center gap-3 border-b border-border bg-background/85 px-4 backdrop-blur">
              ...
              <div className="hidden items-center gap-2 sm:flex">
                ...
                <StatePill tone="demo">demo / static data</StatePill>
              </div>
              <div className="ml-auto flex items-center gap-2">
                <StatePill tone="disconnected">providers not connected</StatePill>
              </div>
            </header>
